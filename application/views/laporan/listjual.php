                ...
                <div class="row d-flex align-items-center">
                  ...
                  $(document).ready(function(){
                    ...
                    document.getElementById('type-filter').addEventListener('change', function(){
                      ...
                      if(this.value == 1){
                          location.href = '<?= site_url('admin/list-penjualan/hari-ini') ?>';
                      }

                      if(this.value == 2){
                        location.href = '<?= site_url('admin/list-penjualan/bulan-ini') ?>';
                      }
                    ...
                    document.getElementById('go-filter').addEventListener('click', function(){
                      ...
                      if (a != '' && b != '') {
                        location.href = '<?= site_url('admin/list-penjualan/custome/') ?>'+a+'/'+b;
                      }else{
