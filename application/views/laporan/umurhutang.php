...
<div class="content-wrapper">
  ...
  <div class="content-header">
      <div class="container-fluid">
          <div class="row mb-2">
          <div class="col-sm-6">
              <h1 class="m-0 text-dark">Umur Hutang</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
          </div><!-- /.row -->
                ...
                <div class="row d-flex align-items-center">
                  ...
                  $(document).ready(function(){
                    document.getElementById('type-filter').addEventListener('change', function(){
                      if(this.value == 1){
                          location.href = '<?= site_url('admin/umur-hutang/hari-ini') ?>';
                      }
                      if(this.value == 2){
                        location.href = '<?= site_url('admin/umur-hutang/bulan-ini') ?>';
                      }
                      if(this.value == 3){
                    ...
                    document.getElementById('go-filter').addEventListener('click', function(){
                      ...
                      if (a != '') {
                        location.href = '<?= site_url('admin/umur-hutang/custome/') ?>'+a;
                      }else{
