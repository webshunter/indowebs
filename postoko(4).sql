...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Jun 2021 pada 11.11
...
CREATE TABLE `datapembelian` (
  ...
  `produk` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `diskon_nominal` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `datapembelian` (`id`, `pembelian_id`, `produk`, `qty`, `satuan`, `harga`, `diskon`, `diskon_nominal`, `jumlah`, `created_at`, `updated_at`, `delete_set`) VALUES
(3, '4', '1', '12', '2', '750000', '10', '15000', '8085000', '2021-06-14 09:07:11', '2021-06-14 04:07:11', '0');
...
(1, 'Gugus Darmayanto', '[\"1\"]', '1', '1', 'Gugus', 'Darmayanto', '', '085800455338', '', 'webshunternet@gmail.com', '', 'Pt Valid Data Solusi', '', '', '', '', 'Jln. Simpang Tenaga II No. 12. Gedung B. Lantai 2. MALANG.', '', '', '', '', 'C-0001', '2021-06-13 03:31:07', NULL, '0'),
...
CREATE TABLE `pembelian` (
  ...
  `hutang` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pajak` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `pembelian` (`id`, `no_nota`, `tanggal`, `termin`, `jatuh_tempo`, `kode`, `nama`, `alamat`, `ongkir`, `pembayaran`, `hutang`, `pajak`, `subtotal`, `total`, `created_at`, `updated_at`, `delete_set`) VALUES
(4, '10001', '2021-06-14', '2', '2021-07-31', '3', 'intan', 'Jln. Simpang Tenaga II No. 12. Gedung B. Lantai 2. MALANG.', '80000', '8000000', '973500', '1', '8085000', '8973500', '2021-06-14 09:07:11', '2021-06-14 04:07:11', '0');
...
--
-- AUTO_INCREMENT untuk tabel `datapembelian`
--
ALTER TABLE `datapembelian`
